...
intentions:
- designing big moments for myself
- trips / LSD
- cagefest
- Intimate rels
- for NF, as exchange 
layout: post
title:  '**"The Power of Moments"** by Chip Heath & Dan Heath (personal notes)'
date:   2025-12-22 12:13:12 +0200
---
^
...
^
- Elevation
	- **Break the script.** (Surprise — × [Made to Stick (unexpected)]({% link 0-book-review/_posts/2025-12-10-made-to-stick-chip-dan-heath-summary.md %}#^unexpected))
		- **"Infrequently enough that it is unexpected."** (× [Debt (irregularity in gifts for reciprocity)]({% link 0-book-review/_posts/2025-04-20-debt-first-5000-years-david-graeber-summary.md %}#^irregularity-for-reciprocity)) Don't break the script consistently – or the delight becomes an expectation. Add randomness. 
...
- Pride
	...
	- Milestone effect: people push to reach a milestone (finish before a mark).
		- ![Milestone effect](https://xaxel.cc/assets/powermoments/milestone-effect.png)
- Insight
	- **Lead to own insight.** (× [Made to Stick]({% link 0-book-review/_posts/2025-12-10-made-to-stick-chip-dan-heath-summary.md %}#^own-conclusion)) Don't tell, don't show me – let them realize. **Make it their own insight.** Don't start with solutions, but dramatize, stage the problem – for self-insight.
	- **Make the abstract concrete.** Donations helping something specific and concrete (× [Made to Stick]({% link 0-book-review/_posts/2025-12-10-made-to-stick-chip-dan-heath-summary.md %}#^concrete)) – getting a personal message back from what the donations enabled.
	- Accomplishment journal (partnered goals — × [Tiny Experiments]({% link 0-book-review/_posts/2025-08-04-tiny-experiments-anne-laure-le-cunff-summary.md %}#^partnered))
	- Father to daughter at dinner table every week: **"What did you guys fail at this week?"** "If we had nothing to tell him, he'd be disappointed." (× [Improvise]({% link 0-book-review/_posts/2022-12-15-improvise-max-dickins-summary.md %}))
	...
	- **You can get over any fear.** (Exposure therapy — also × CZC (though there it was more about changing one's relationship to fear)) Two hours to get arachnophobes to touch a [tarantula](https://www.youtube.com/watch?v=eZzw-ZtcKi4).
...
- Connection
	...
	- **Meetings can be alive.** "People hate meetings because emotion is deliberately squeezed out. But this is a choice, not an inevitability. You can just as easily conduct a meeting that has drama, meaning, and connection."
		- **Brave plant**. When running a meeting, have a plant that asks a tough question — to allow others to do the same. (× [Nudge]({% link 0-book-review/_posts/2024-03-30-nudge-summary.md %}))
^
