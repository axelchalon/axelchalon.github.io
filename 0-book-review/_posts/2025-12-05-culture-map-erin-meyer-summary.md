...
intentions:
- Learning about work cultures and countries
- Noticing the differences at previous workplaces
- Maybe figuring out with which countries I'd vibe the most -- maybe for a (work) visit
- Improving people skill / emotional IQ (focussed)
layout: post
title:  '**"The Culture Map"** by Erin Meyer (personal notes)'
date:   2025-12-05 12:13:12 +0200
---
^
...
- **Communication style: explicit/implicit** (direct/indirect).
	- **Implicit cultures** (Asia, to a lesser extent France (Jean de la Fontaine, rewriting letters politely, etc.))
		...
		- **<span style="position:relative; top: 10px;">"No"</span> is said between the lines.** (Asia — especially to clients/bosses)
			- People refuse out of politeness, have to be [asked twice](https://www.youtube.com/watch?v=zC_5OsEPp4A) again to tell the real answer.
			- Soft refusals to protect the other's [face]({% link 0-book-review/_posts/2025-12-05-culture-map-erin-meyer-summary.md %}#^face) (as if masks weren't enough).
...
- **Persuasion** (principles/practical ; theory/practice)
	- **Principles vs practice**
		...
		- **Practical:** (USA)
			...
			- (inductive - × [Psychedelics Revealing]({% link 0-book-review/_posts/2025-03-10-aidan-lyon-psychedelic-experience-revealing-mind-summary.md %}#^inference-vs-experience), × [theories looking for applications and v/v]({% link 0-book-review/_posts/2025-07-03-skin-in-the-game-summary.md %}#^theories-looking-for-applications); **experience calling for understanding**)
		- Shows in:
...
- **Decision process** (top-down/consensual)
	...
	- [Nemawashi]({% link 0-book-review/_posts/2023-11-30-the-toyota-way-jeffrey-liker-summary.md %}#^nemawashi) (JP): **getting informal buy-in (consensus) before officially announcing the decision.** Do it as a Westerner as well. (× "Being at the [gemba]({% link 0-book-review/_posts/2023-11-30-the-toyota-way-jeffrey-liker-summary.md %}#^gemba)" with frontline workers)
...
- **Trusting** (task-based/relationship-based)
	- Historically, cultures with no strong legal framework became relationship-based.
		- (But also: in-group cultures & knowing everyone, [Debt]({% link 0-book-review/_posts/2025-04-20-debt-first-5000-years-david-graeber-summary.md %}))
	...
	- Task-based
		- "—Why can't we just get down to business and sign a contract? —Remember, in many cultures, **the relationship *is* your contract**." (× [Debt]({% link 0-book-review/_posts/2025-04-20-debt-first-5000-years-david-graeber-summary.md %}), [Money]({% link 0-book-review/_posts/2024-05-09-money-unauthorized-biography-felix-martin-summary.md %}))
		- Relationships with colleagues usually stop with their employment.
		- Cold calls are okay.
	- Relationship-based (BRIC: BR, RU, IN, CN)
		- Nomunication (JP): **drinks with coworkers & managers.** (× [Trying Not to Try]({% link 0-book-review/_posts/2023-04-15-trying-not-to-try-slingerland-summary.md %})) If drinks are not for you, then karaoke, or spa.
		- **Share more meals, get to know them personally. Show your non-professional self.**
		- Cold calls are disfavoured. **Ask a common friend to introduce you.** (× [The Mom Test]({% link 0-book-review/_posts/2025-08-04-mom-test-rob-fitzpatrick-summary.md %}#^cold-approaches) — the goal of cold approaches is to stop having them.)
	...
	- [Peach](https://www.youtube.com/watch?v=6MZhaX8P3W8) vs [coconut](https://www.youtube.com/watch?v=G-aXOJXreTk). Hard shell but soft inside (RU); soft outside (friendly) but quickly hitting the hard kernel (BR).
- **Disagreement** (confrontational/avoidant)
	...
	- <a name="^face"></a>"[Face](https://www.youtube.com/watch?v=5Lat6Jz5WlQ)" (as line/role, persona — e.g. acting out "a professor specialized in cross-cultural management") (× [To The Actor]({% link 0-book-review/_posts/2025-03-18-michael-chekhov-to-the-actor-summary.md %}))
...
^
- **Countries' positions on the scale are relative to your own culture — not absolute.** An implicit culture can still be explicit compared to yours. (× ["most people need it, but not you" (Psycho-Cybernetics)]({% link 0-book-review/_posts/2023-08-15-the-new-psycho-cybernetics-summary.md %}#^but-not-you))
...
^
- <a name="^meta"></a>**Meta-discuss communication & cultural styles.**
	- **Making explicit and clarifying always helps.** (× directness (relationships) (Pavlina, etc.)) (× communication, [Sex Talks]({% link 0-book-review/_posts/2023-06-15-sex-talks-vanessa-marin-summary.md %}), [Come As You Are]({% link 0-book-review/_posts/2025-03-03-emily-nagoski-come-as-you-are-summary.md %}),  butter, etc.) — especially when you're coming from different cultures. Doing the dance of implicitness only works if you come from the same culture.
...
^
- **Self-deprecate your culture and flatter the other's** — when confronted with a cultural issue or making a [fax piss](https://www.youtube.com/watch?v=BZVBTtX92Nc). **Laugh about your own culture.** (× [Sex Talks: laugh about it]({% link 0-book-review/_posts/2023-06-15-sex-talks-vanessa-marin-summary.md %}#^laugh-about-it))
^
...
<li>
<details>
  <summary style="opacity: 0;"></summary>
<ul>
<li style="margin-bottom: 125px;"><img src="https://xaxel.cc/assets/cmap/cm1.png" /></li>
<li style="margin-bottom: 125px;"><img src="https://xaxel.cc/assets/cmap/cm1b.png" /></li>
<li style="margin-bottom: 125px;"><img src="https://xaxel.cc/assets/cmap/cm2.png" /></li>
<li style="margin-bottom: 125px;"><img src="https://xaxel.cc/assets/cmap/cm3.png" /></li>
<li style="margin-bottom: 125px;"><img src="https://xaxel.cc/assets/cmap/cm4.png" /></li>
<li style="margin-bottom: 125px;"><img src="https://xaxel.cc/assets/cmap/cm5.png" /></li>
<li style="margin-bottom: 125px;"><img src="https://xaxel.cc/assets/cmap/cm6.png" /></li>
<li style="margin-bottom: 125px;"><img src="https://xaxel.cc/assets/cmap/cm7.png" /></li>
<li style="margin-bottom: 125px;"><img src="https://xaxel.cc/assets/cmap/cm8.png" /></li>
<li style="margin-bottom: 125px;"><img src="https://xaxel.cc/assets/cmap/cm9.png" /></li>
<li style="margin-bottom: 125px;"><img src="https://xaxel.cc/assets/cmap/cm9b.png" /></li>
</ul>
</details>
</li>
</ul>