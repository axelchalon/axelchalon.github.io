...
intentions:
- Becoming a master matchmaker
- Hosting "informal" hangouts and making sparks happen
- Ideas for NF Party on Saturday
- World of mutual matchmaking
layout: post
title:  '**"The 2-Hour Cocktail Party"** by Nick Gray (personal notes)'
date:   2025-12-23 12:13:12 +0200
started: 2025-12-16
finished: 2025-12-18
---
^

Hello human. Here is method to make connection with other humans. See also [The Art of Gathering]({% link 0-book-review/_posts/2024-12-30-priya-parker-art-of-gathering-summary.md %}).
<br>
---
<br>
# General
- **When was the last time you made a new friend?**
	- **Make friends early.** (× ["start earlier to benefit longer"]({% link 0-book-review/_posts/2025-08-04-mom-test-rob-fitzpatrick-summary.md %}#^benefit)) "I'm getting older. Now is the best time to make a few new meaningful relationships."
- **Don't attend bad events.** Host great events yourself instead. (× [create your own meetups (The Mom Test)]({% link 0-book-review/_posts/2025-08-04-mom-test-rob-fitzpatrick-summary.md %}#^create-own))
...
- **Host <mark>every six to eight weeks</mark> to keep momentum.** The biggest benefits will happen when hosting parties frequently.
...
- **[Partnered XPs]({% link 0-book-review/_posts/2025-08-04-tiny-experiments-anne-laure-le-cunff-summary.md %}#^partnered)**: hosting 2-hour cocktail parties with your roommate (or someone else).
^
# Specific
^
...
- **Invite each guest personally before sending them the RSVP.** Make them feel special. Explain motivations as needed (× [VFWAP]({% link 0-book-review/_posts/2025-08-04-mom-test-rob-fitzpatrick-summary.md %}#^vfwap) for special guests). "**Are you free then? Or can I send you more info?**" If yes/maybe: send event page link, ask to RSVP. If no: ask if you can invite them the next time you host an event (add their name to list).
...
- **Name tags.** (× [pop-up rules as levellers (The Art of Gathering)]({% link 0-book-review/_posts/2024-12-30-priya-parker-art-of-gathering-summary.md %}#^leveller)) Written by host on arrival with a non-smearing marker in block letters.
...
- **Icebreakers**
	- **Do the <mark>first ice-breaker</mark> with the first 4-5 guests.**
	...
	- **<mark>Second ice-breaker</mark>** at 19.30
...
^
# Meta 
- Meta: Elements of book-writing (× [Tiny XP]({% link 0-book-review/_posts/2025-08-04-tiny-experiments-anne-laure-le-cunff-summary.md %}#^book-writing))
	- Catchy (flagship) name, even if not necessarily accurate. ("2-hour cocktail party"; rather than just "party")
	- Start with the results (success stories) (× [persuasion: principled or practical (Culture Map)]({% link 0-book-review/_posts/2025-12-05-culture-map-erin-meyer-summary.md %}#^persuasion))
	- Have regular asides, e.g. "Ask the party professional. Q/A" (cf [The Power of Moments]({% link 0-book-review/_posts/2025-12-22-power-of-moments-chip-dan-heath-summary.md %}), [Made to Stick]({% link 0-book-review/_posts/2025-12-10-made-to-stick-chip-dan-heath-summary.md %}), [I Will Teach You To Be Rich]({% link 0-book-review/_posts/2025-07-02-i-will-teach-you-to-be-rich-summary.md %}) — especially in self-development books).
	- Repeat highlights in small format. "Party Pro Tip" after a paragraph.
	- Social proof / Testimonials for weird advice (party harmonica).