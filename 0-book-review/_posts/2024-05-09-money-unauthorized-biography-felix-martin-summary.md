...
* **Money doesn't have to rule a society.** In post-WWI USSR, workers were paid in (food) vouchers; thereby containing the role of money in society (rationing).
	* Industries across a supply chain can collaborate to create a monetary system. (× "in-group" (nudge); [create clubs]({% link 0-book-review/_posts/2024-03-30-nudge-summary.md %}#^create-clubs))
